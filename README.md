...
## External Libraries  
* [lslib](https://github.com//)
* [tolk](https://github.com//)

# Credits

* Thanks to [Norbyte](https://github.com/) for creating [LSLib](https://github.com//), which allows various features of the manager (getting data from paks, reading lsb files, just to name a few).
* [Dan Iorgulescu](https://www..com/) (Concept Artist on Baldur's Gate III at Larian Studios) for the [beautiful key/box art](https://www..//mV159) used for the app icon (Fane's head) as of 12/20/2019.
